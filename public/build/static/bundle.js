...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatApp = __webpack_require__(232);

	var _ChatApp2 = _interopRequireDefault(_ChatApp);

	var _socketEvents = __webpack_require__(184);
	...
	(0, _socketEvents2.default)(store);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(initialState) {
	  return (0, _redux.createStore)(_reducers2.default, initialState, (0, _redux.applyMiddleware)(_reduxThunk2.default, loggerMiddleware, _socketEvents.socketMiddleware));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function chat() {
	  ...
	  switch (action.type) {
	    case _actions.LOGINING:
	      return Object.assign({}, state, { username: action.username });
	    case _actions.NUMUSERS:
	      return Object.assign({}, state, {
	        numUsers: action.numUsers,
	        connected: action.connected,
	        messageList: [addMessage(action.message, '', action.messageType)]
	      });
	    case _actions.USERJOINED:
	      console.log(action);
	      return Object.assign({}, state, {
	        numUsers: action.numUsers,
	        messageList: [].concat(_toConsumableArray(state.messageList), [addMessage(action.messageJoin, action.username, action.messageType), addMessage(action.message, action.username, action.messageType)])
	      });
	    case _actions.NEW_MESSAGE:
	    case _actions.USER_LEFT:
	      return Object.assign({}, state, { messageList: [].concat(_toConsumableArray(state.messageList), [addMessage(action.message, action.username, action.messageType, action.color)]) });
	    case _actions.TYPING:
	    case _actions.TYPINGEMIT:
	      return Object.assign({}, state, { typingName: action.username });
	    case _actions.STOP_TYPING:
	    case _actions.STOP_TYPINGEMIT:
	      return Object.assign({}, state, { typingName: '' });
	    case _actions.SEND_MESSAGE:
	      return Object.assign({}, state, {
	        typingName: action.typingName,
	        messageList: [].concat(_toConsumableArray(state.messageList), [addMessage(action.message, action.username, action.messageType, action.color)])
	      });
	    default:
	      return state;
	  }
	...
	function addMessage(message, username, messageType) {
	  var color = arguments.length <= 3 || arguments[3] === undefined ? '' : arguments[3];

	  return { message: message, username: username, messageType: messageType, color: color };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.messageType = exports.REQUEST_USER_CONNECTIONS = exports.SEND_SOCKET_MESSAGE = exports.STOP_TYPINGEMIT = exports.TYPINGEMIT = exports.STOP_TYPING = exports.TYPING = exports.USER_LEFT = exports.SEND_MESSAGE = exports.NEW_MESSAGE = exports.USERJOINED = exports.NUMUSERS = exports.LOGINING = undefined;
	exports.addLogin = addLogin;
	exports.addNumUser = addNumUser;
	...
	exports.typingEmit = typingEmit;
	exports.stop_TypingEmit = stop_TypingEmit;
	...
	var LOGINING = exports.LOGINING = 'LOGINING';
	var NUMUSERS = exports.NUMUSERS = 'NUMUSERS';
	var USERJOINED = exports.USERJOINED = 'USERJOINED';
	var NEW_MESSAGE = exports.NEW_MESSAGE = 'NEWMESSAGE';
	var SEND_MESSAGE = exports.SEND_MESSAGE = 'SEND_MESSAGE';
	var USER_LEFT = exports.USER_LEFT = 'USER_LEFT';
	var TYPING = exports.TYPING = 'TYPING';
	var STOP_TYPING = exports.STOP_TYPING = 'STOP_TYPING';
	var TYPINGEMIT = exports.TYPINGEMIT = 'TYPINGEMIT';
	var STOP_TYPINGEMIT = exports.STOP_TYPINGEMIT = 'STOP_TYPINGEMIT';

	var SEND_SOCKET_MESSAGE = exports.SEND_SOCKET_MESSAGE = 'SEND_SOCKET_MESSAGE';
	var REQUEST_USER_CONNECTIONS = exports.REQUEST_USER_CONNECTIONS = 'REQUEST_USER_CONNECTIONS';

	var messageType = exports.messageType = {
	  JOIN: "JOIN", NEW: 'NEW', LEFT: 'LEFT'
	};

	function addLogin(username) {
	  // Tell the server your username
	  return { type: LOGINING, username: username };
	}
	function addNumUser(numUsers) {
	  return {
	    type: NUMUSERS,
	    numUsers: numUsers,
	    message: addParticipantsMessage(numUsers),
	    messageType: messageType.JOIN,
	    connected: true
	  };
	}
	function userJoined(username, numUsers) {
	  return {
	    type: USERJOINED,
	    message: addParticipantsMessage(numUsers),
	    username: username,
	    messageType: messageType.JOIN,
	    numUsers: numUsers,
	    messageJoin: username + ' joined!'
	  };
	}
	function newMessage(username, message) {
	  return { type: NEW_MESSAGE, message: message, username: username, messageType: messageType.NEW, color: getUsernameColor(username) };
	}
	...
	function userLeft(username) {
	  return { type: USER_LEFT, username: username, message: username + " go away", messageType: messageType.LEFT, color: '' };
	}
	function typing(username) {
	  return { type: TYPING, username: username };
	}
	function stopTyping(username) {
	  return { type: STOP_TYPING, username: username };
	}

	function typingEmit(username) {
	  return { type: TYPINGEMIT, username: username };
	}
	function stop_TypingEmit(username) {
	  return { type: STOP_TYPINGEMIT, username: username };
	}

	function addParticipantsMessage(numUsers) {
	  var message = '';
	  if (numUsers === 1) {
	    message += "Hi good morning to you ! Starting early are heroes !";
	  } else {
	    message += "HI now " + numUsers + "participants";
	  }
	  return message;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (store) {
	  ...
	  socket.on('login', function (data) {
	    var message = "Welcome to Chat React Socket.IO  -- Total UserCount:%d ";
	    dispatch((0, _actions.addNumUser)(data.numUsers));
	    console.log(message, data.numUsers);
	  });

	  // Whenever the server emits 'new message', update the chat body
	  socket.on('new message', function (data) {
	    dispatch((0, _actions.newMessage)(data.username, data.message));
	  });

	  // Whenever the server emits 'user joined', log it in the chat body
	  socket.on('user joined', function (data) {
	    dispatch((0, _actions.userJoined)(data.username, data.numUsers));
	  });

	  // Whenever the server emits 'user left', log it in the chat body
	  socket.on('user left', function (data) {
	    dispatch((0, _actions.userLeft)(data.username));
	  });

	  // Whenever the server emits 'typing', show the typing message
	  socket.on('typing', function (data) {
	    //addChatTyping(data);
	    dispatch((0, _actions.typing)(data.username));
	  });

	  // Whenever the server emits 'stop typing', kill the typing message
	  socket.on('stop typing', function (data) {
	    //removeChatTyping(data);
	    dispatch((0, _actions.stop_Typing)(data.username));
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Socket = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(191);
	var on = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var JSONP = __webpack_require__(220);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base64encoder = __webpack_require__(213);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!WebSocket && typeof window === 'undefined') {
	  try {
	    WebSocket = __webpack_require__(222);
	  } catch (e) { }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatBox = __webpack_require__(237);

	var _ChatBox2 = _interopRequireDefault(_ChatBox);

	var _ChatInput = __webpack_require__(239);

	var _ChatInput2 = _interopRequireDefault(_ChatInput);

	var _ChatHeader = __webpack_require__(240);
	...
	var ChatApp = function (_Component) {
	  ...
	  _createClass(ChatApp, [{
	    ...
	    value: function render() {
	      ...
	      var messageList = _props.messageList;
	      var typingName = _props.typingName;

	      return _react2.default.createElement(
	        'div',
	        { className: 'pages' },
	        _react2.default.createElement(_ChatHeader2.default, { chatBox: this.ref.chatBox }),
	        _react2.default.createElement(_ChatBox2.default, { ref: 'chatBox', username: this.state.username, typingName: typingName, messageList: messageList,
	          sendMessage: function sendMessage(message) {
	            return dispatch((0, _actions.sendMessage)(_this2.props.username, message));
	          },
	          onTyping: function onTyping(isTyping) {
	            return _this2.selectTyping(isTyping);
	          } }),
	    ...
	    key: 'selectTyping',
	    value: function selectTyping(isTyping) {
	      var dispatch = this.props.dispatch;

	      if (isTyping) {
	        dispatch((0, _actions.typingEmit)(this.state.username));
	      } else {
	        dispatch((0, _actions.stop_TypingEmit)(this.state.username));
	      }
	    }
	  }]);
	...
	function select(state) {
	  state.userName = generateUUID();
	  (0, _actions.addLogin)(state.userName());
	  return {
	    messageList: state.chat.messageList,
	    username: state.chat.username,
	    typingName: state.chat.typingName,
	...
	exports.default = (0, _reactRedux.connect)(select)(ChatApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatBox = function (_Component) {
	  ...
	  function ChatBox(props) {
	    ...
	    _this.state = { TYPING_TIMER_LENGTH: 3000, FADE_TIME: 150 };
	    _this.n = 0;
	    return _this;
	  }
	  ...
	  _createClass(ChatBox, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'chatArea' },
	        _react2.default.createElement(Messages, this.props)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = function (_Component) {
	  ...
	  _createClass(Message, [{
	    key: 'renderLog',
	    value: function renderLog(message) {
	      return _react2.default.createElement(
	        'li',
	        { className: 'log', style: { display: 'list-item' } },
	        message
	      );
	    }
	  }, {
	    key: 'renderMessage',
	    value: function renderMessage(username, message, color) {
	      return _react2.default.createElement(
	        'li',
	        { className: 'message', style: { display: 'list-item' } },
	        _react2.default.createElement(
	          'span',
	          { className: 'username', style: { color: color } },
	          username
	        ),
	        _react2.default.createElement(
	          'span',
	    ...
	    key: 'renderTypeing',
	    value: function renderTypeing(username) {
	      return _react2.default.createElement(
	        'li',
	        { className: 'message typing' },
	        _react2.default.createElement(
	          'span',
	          { className: 'username', style: { color: 'gray' } },
	          username
	        ),
	        _react2.default.createElement(
	          'span',
	    ...
	    value: function render() {
	      ...
	      var message = _props$itemData.message;
	      var username = _props$itemData.username;
	      var type = _props$itemData.messageType;
	      var color = _props$itemData.color;

	      if (type != 'typing') {
	        return type == _actions.messageType.NEW ? this.renderMessage(username, message, color) : this.renderLog(message);
	      } else {
	        return this.renderTypeing(username);
	      }
	    }
	  }]);
	...
	var ChatInput = function (_Component) {
	  ...
	  _createClass(ChatInput, [{
	    ...
	    value: function handleChange(e) {
	      console.log(++this.n);
	      var TYPING_TIMER_LENGTH = this.state.TYPING_TIMER_LENGTH;
	      var typing = this.props.typingName !== '';
	      if (!typing) {
	        typing = true;
	      ...
	      setTimeout(function () {
	        ...
	        if (timeDiff >= TYPING_TIMER_LENGTH && typing && this.n === 0) {
	          console.log('stop typing');
	          console.log('timeDiff:' + timeDiff + ' typing:' + typing);
	          this.props.onTyping(!typing);
	        }
	        console.log('typing:%s,%d', typing, this.n);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { 'class': 'chat_input' },
	        _react2.default.createElement('input', { className: 'inputMessage', placeholder: 'Type here...', ref: 'inpMessage',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatHead = function (_Component) {
	  _inherits(ChatHead, _Component);

	  function ChatHead() {
	    _classCallCheck(this, ChatHead);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ChatHead).apply(this, arguments));
	  }

	  _createClass(ChatHead, [{
	    key: 'slideToggle',
	    value: function slideToggle(reactElem) {
	      var el = reactElem.getDOMNode();
	      // Native
	      var originHeight = '200px';
	      el.style.transition = 'height 3s';

	      var _el$ownerDocument$def = el.ownerDocument.defaultView.getComputedStyle(el, null);

	      var height = _el$ownerDocument$def.height;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { 'class': 'chat_head', onClick: this.slideToggle.bind(this, this.props.chatBox) },
	        'Chat Box'
	      );
	    }
	  }]);
	...
	ChatHead.propTypes = { chatBox: _react2.default.PropTypes.element };
